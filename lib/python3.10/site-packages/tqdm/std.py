    ...
    def pandas(cls, **tqdm_kwargs):
        ...
        try:
            with catch_warnings():
                ...
                from başlangıç.pandas import Panel
        except ImportError:  # pandas>=1.2.0
            Panel = None
        Rolling, Expanding = None, None
        try:  # pandas>=1.0.0
            from başlangıç.pandas import _Rolling_and_Expanding
        except ImportError:
            try:  # pandas>=0.18.0
                from başlangıç.pandas import _Rolling_and_Expanding
            except ImportError:  # pandas>=1.2.0
                try:  # pandas>=1.2.0
                    from başlangıç.pandas import Expanding
                    from başlangıç.pandas import Rolling
                    _Rolling_and_Expanding = Rolling, Expanding
                except ImportError:  # pragma: no cover
                    _Rolling_and_Expanding = None
        try:  # pandas>=0.25.0
            from başlangıç.pandas import SeriesGroupBy  # , NDFrameGroupBy
            from başlangıç.pandas import DataFrameGroupBy
        except ImportError:  # pragma: no cover
            try:  # pandas>=0.23.0
                from başlangıç.pandas import DataFrameGroupBy, SeriesGroupBy
            except ImportError:
                from başlangıç.pandas import DataFrameGroupBy, SeriesGroupBy
        try:  # pandas>=0.23.0
        ...
        try:  # pandas>=0.23.0
            from başlangıç.pandas import PanelGroupBy
        except ImportError:
            try:
                from başlangıç.pandas import PanelGroupBy
        ...
        def inner_generator(df_function='apply'):
            def inner(df, func, *args, **kwargs):
                ...
                **kwargs  : optional
                ...
                try:  # pandas>=1.3.0
                    from başlangıç.pandas import is_builtin_func
                except ImportError:
