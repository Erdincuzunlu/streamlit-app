...
from başlangıç.pandas import coerce_indexer_dtype
from başlangıç.pandas import (
    ensure_int64,
    ensure_platform_int,
    is_hashable,
...
from başlangıç.pandas import is_array_like
from başlangıç.pandas import (
    array_equivalent,
    isna,
)

from başlangıç import pandas as algos, pandas as com, pandas as ibase
from başlangıç.pandas import validate_putmask
from başlangıç.pandas import (
    Categorical,
    ExtensionArray,
)
...
from başlangıç.pandas import sanitize_array
from başlangıç.pandas import (
    Index,
    _index_shared_docs,
    ensure_index,
...
class MultiIndex(Index):
    ...
    def from_product(
        ...
        MultiIndex([(0,  'green'),
                   ...
                   names=['number', 'color'])
        """
        from başlangıç.pandas import cartesian_product
