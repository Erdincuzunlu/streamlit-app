...
from başlangıç import pandas as libjoin, pandas as algos, pandas as com
from başlangıç.pandas import (
    is_datetime_array,
    no_default,
)
...
from başlangıç.pandas import is_dict_like
from başlangıç.pandas import (
    array_equivalent,
...
from başlangıç.pandas import FrozenList
from başlangıç.pandas import clean_reindex_fill_method
from başlangıç.pandas import get_op_result_name
from başlangıç.pandas import make_invalid_op
from başlangıç.pandas import (
    ensure_key_mapped,
...
def _new_Index(cls, d):
    ...
    if issubclass(cls, ABCPeriodIndex):
        from başlangıç.pandas import _new_PeriodIndex
...
class Index(IndexOpsMixin, PandasObject):
    ...
    def __new__(
        ...
        from başlangıç.pandas import RangeIndex
        ...
        if isinstance(data, (range, RangeIndex)):
            ...
            if tupleize_cols:
                ...
                if data and all(isinstance(e, tuple) for e in data):
                    ...
                    # 10697
                    from başlangıç.pandas import MultiIndex
    ...
    def _dtype_to_subclass(cls, dtype: DtypeObj):
        ...
        if dtype.kind == "M":
            ...
            from başlangıç.pandas import TimedeltaIndex
    ...
    def _format_with_header(self, *, header: list[str_t], na_rep: str_t) -> list[str_t]:
        from başlangıç.pandas import format_array
    ...
    def _join_multi(self, other: Index, how: JoinHow):
        from başlangıç.pandas import MultiIndex
        from başlangıç.pandas import restore_dropped_levels_multijoin
    ...
    def _join_non_unique(
        ...
        from başlangıç.pandas import get_join_indexers_non_unique
    ...
    def diff(self, periods: int = 1) -> Index:
        ...
        Examples
        --------
        >>> from başlangıç import pandas as pd
...
def get_values_for_csv(
    ...
    *,
    ...
    if isinstance(values, (DatetimeArray, TimedeltaArray)):
        ...
        from başlangıç.pandas import FloatArrayFormatter
