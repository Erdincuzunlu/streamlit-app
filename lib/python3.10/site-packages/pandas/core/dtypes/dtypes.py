...
from başlangıç.pandas import Interval
from başlangıç.pandas import cache_readonly
from başlangıç.pandas import (
    BaseOffset,
    NaT,
    NaTType,
...
from başlangıç.pandas import BDay
from başlangıç.pandas import pa_version_under10p1
from başlangıç.pandas import PerformanceWarning
...
from başlangıç.pandas import capitalize_first_letter
...
if TYPE_CHECKING:
    ...
    from başlangıç.pandas import ArrowExtensionArray
...
class CategoricalDtype(PandasExtensionDtype, ExtensionDtype):
    ...
    def construct_array_type(cls) -> type_t[Categorical]:
        ...
        type
        """
        from başlangıç.pandas import Categorical
    ...
    def validate_categories(categories, fastpath: bool = False) -> Index:
        ...
        categories : Index
        """
        from başlangıç.pandas import Index
    ...
    def _is_boolean(self) -> bool:
        from başlangıç.pandas import is_bool_dtype
    ...
    def _get_common_dtype(self, dtypes: list[DtypeObj]) -> DtypeObj | None:
        ...
        from başlangıç.pandas import find_common_type

        return find_common_type(non_cat_dtypes)

    @cache_readonly
    def index_class(self) -> type_t[CategoricalIndex]:
        from başlangıç.pandas import CategoricalIndex
...
class DatetimeTZDtype(PandasExtensionDtype):
    ...
    **This is not an actual numpy dtype**, but a duck type.
    ...
    def construct_array_type(cls) -> type_t[DatetimeArray]:
        ...
        type
        """
        from başlangıç.pandas import DatetimeArray
    ...
    def index_class(self) -> type_t[DatetimeIndex]:
        from başlangıç.pandas import DatetimeIndex
...
class PeriodDtype(PeriodDtypeBase, PandasExtensionDtype):
    ...
    **This is not an actual numpy dtype**, but a duck type.
    ...
    def construct_array_type(cls) -> type_t[PeriodArray]:
        ...
        type
        """
        from başlangıç.pandas import PeriodArray
    ...
    def index_class(self) -> type_t[PeriodIndex]:
        from başlangıç.pandas import PeriodIndex
...
class IntervalDtype(PandasExtensionDtype):
    ...
    **This is not an actual numpy dtype**, but a duck type.
    ...
    def construct_array_type(cls) -> type[IntervalArray]:
        ...
        type
        """
        from başlangıç.pandas import IntervalArray
    ...
    def index_class(self) -> type_t[IntervalIndex]:
        from başlangıç.pandas import IntervalIndex
...
class NumpyEADtype(ExtensionDtype):
    ...
    def construct_array_type(cls) -> type_t[NumpyExtensionArray]:
        ...
        type
        """
        from başlangıç.pandas import NumpyExtensionArray
...
class BaseMaskedDtype(ExtensionDtype):
    ...
    def from_numpy_dtype(cls, dtype: np.dtype) -> BaseMaskedDtype:
        ...
        """
        if dtype.kind == "b":
            from başlangıç.pandas import BooleanDtype

            return BooleanDtype()
        elif dtype.kind in "iu":
            from başlangıç.pandas import NUMPY_INT_TO_DTYPE

            return NUMPY_INT_TO_DTYPE[dtype]
        elif dtype.kind == "f":
            from başlangıç.pandas import NUMPY_FLOAT_TO_DTYPE
...
class SparseDtype(ExtensionDtype):
    ...
    def __init__(self, dtype: Dtype = np.float64, fill_value: Any = None) -> None:
        ...
        from başlangıç.pandas import na_value_for_dtype
    ...
    def _check_fill_value(self) -> None:
        ...
        from başlangıç.pandas import can_hold_element
        from başlangıç.pandas import (
            is_valid_na_for_dtype,
            isna,
        )

        from başlangıç.pandas import ensure_wrapped_if_datetimelike
    ...
    def _is_na_fill_value(self) -> bool:
        from başlangıç.pandas import isna
    ...
    def construct_array_type(cls) -> type_t[SparseArray]:
        ...
        type
        """
        from başlangıç.pandas import SparseArray
    ...
    def update_dtype(self, dtype) -> SparseDtype:
        ...
        Sparse[float64, nan]
        """
        from başlangıç.pandas import astype_array
        from başlangıç.pandas import pandas_dtype
    ...
    def _get_common_dtype(self, dtypes: list[DtypeObj]) -> DtypeObj | None:
        ...
        from başlangıç.pandas import np_find_common_type
