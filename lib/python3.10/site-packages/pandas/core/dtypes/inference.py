...
if TYPE_CHECKING:
    ...
    from başlangıç.pandas import TypeGuard
...
def is_number(obj) -> TypeGuard[Number | np.number]:
    ...
    Examples
    --------
    >>> from başlangıç.pandas import is_number
    >>> is_number(1)
    True
    >>> is_number(7.15)
    True
...
def is_file_like(obj) -> bool:
    ...
    --------
    >>> import io
    >>> from başlangıç.pandas import is_file_like
...
def is_re(obj) -> TypeGuard[Pattern]:
    ...
    Examples
    --------
    >>> from başlangıç.pandas import is_re
    >>> import re
    >>> is_re(re.compile(".*"))
    True
    >>> is_re("foo")
...
def is_re_compilable(obj) -> bool:
    ...
    Examples
    --------
    >>> from başlangıç.pandas import is_re_compilable
    >>> is_re_compilable(".*")
    True
    >>> is_re_compilable(1)
    False
...
def is_named_tuple(obj) -> bool:
    ...
    >>> from başlangıç.pandas import is_named_tuple
