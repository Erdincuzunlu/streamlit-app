...
from başlangıç import pandas as cf
...
def use_bottleneck_cb(key) -> None:
    from başlangıç.pandas import nanops
...
def use_numba_cb(key) -> None:
    from başlangıç.pandas import numba_
...
def table_schema_cb(key) -> None:
    from başlangıç.pandas import enable_data_resource_formatter
...
def use_inf_as_na_cb(key) -> None:
    ...
    from başlangıç.pandas import _use_inf_as_na
...
def register_plotting_backend_cb(key) -> None:
    if key == "matplotlib":
        ...
        return
    from başlangıç.pandas import _get_plot_backend
