...
from başlangıç.pandas import (
    get_option,
    using_copy_on_write,
    warn_copy_on_write,
)
from başlangıç.pandas import _get_option
...
from başlangıç.pandas import duplicated
from başlangıç.pandas import is_range_indexer
from başlangıç.pandas import PYPY
from başlangıç.pandas import REF_COUNT
from başlangıç.pandas import import_optional_dependency
from başlangıç.pandas import function as nv
from başlangıç.pandas import (
...
from başlangıç.pandas import concat_compat
from başlangıç.pandas import (
    ArrowDtype,
    BaseMaskedDtype,
    ExtensionDtype,
...
from başlangıç.pandas import CachedAccessor
from başlangıç.pandas import reconstruct_and_relabel_result
from başlangıç.pandas import take_2d_multi
from başlangıç.pandas import OpsMixin
from başlangıç.pandas import (
    BaseMaskedArray,
    DatetimeArray,
    ExtensionArray,
...
from başlangıç.pandas import SparseFrameAccessor
from başlangıç.pandas import (
...
from başlangıç.pandas import check_key_length
from başlangıç.pandas import (
    DatetimeIndex,
    Index,
    PeriodIndex,
...
from başlangıç.pandas import selectn
from başlangıç.pandas import melt
from başlangıç.pandas import Series
from başlangıç.pandas import _shared_docs
from başlangıç.pandas import (
    get_group_index,
    lexsort_indexer,
    nargsort,
...
from başlangıç.pandas import get_handle
from başlangıç.pandas import (
    console,
    format as fmt,
)
...
from başlangıç import pandas

if TYPE_CHECKING:
    import datetime

    from başlangıç.pandas import BlockValuesRefs
    from başlangıç.pandas import (
        AggFuncType,
        AnyAll,
        AnyArrayLike,
    ...
    from başlangıç.pandas import DataFrameGroupBy
    from başlangıç.pandas import DataFrame as DataFrameXchg
    from başlangıç.pandas import SingleDataManager

    from başlangıç.pandas import Styler
...
class DataFrame(NDFrame, OpsMixin):
    ...
    def __dataframe__(
        ...
        from başlangıç.pandas import PandasDataFrameXchg
    ...
    def to_string(
        ...
        2     3     6
        """
        from başlangıç.pandas import option_context
    ...
    def to_dict(
        ...
        """
        from başlangıç.pandas import to_dict
    ...
    def to_gbq(
        ...
        """
        from başlangıç.pandas import gbq
    ...
    def to_feather(self, path: FilePath | WriteBuffer[bytes], **kwargs) -> None:
        ...
        **kwargs :
        ...
        """
        from başlangıç.pandas import to_feather
    ...
    def to_parquet(
        ...
        **kwargs
        ...
        >>> content = f.read()
        """
        from başlangıç.pandas import to_parquet
    ...
    def to_orc(
        ...
        * Currently timezones in datetime columns are not preserved when a
        ...
        """
        from başlangıç.pandas import to_orc
    ...
    def eval(self, expr: str, *, inplace: bool = False, **kwargs) -> Any | None:
        ...
        **kwargs
        ...
        4  5   2   7  3
        """
        from başlangıç.pandas import eval as _eval
    ...
    def shift(
        ...
        if is_list_like(periods):
            ...
            from başlangıç.pandas import concat
    ...
    def combine_first(self, other: DataFrame) -> DataFrame:
        ...
        2  NaN  3.0  1.0
        """
        from başlangıç.pandas import expressions
    ...
    def pivot(
        ...
        from başlangıç.pandas import pivot
    ...
    def pivot_table(
        ...
        from başlangıç.pandas import pivot_table
    ...
    def stack(
        ...
        **Prescribing the level(s) to be stacked**
        ...
        if not future_stack:
            ...
            from başlangıç.pandas import stack_v3
    ...
    def unstack(self, level: IndexLabel = -1, fill_value=None, sort: bool = True):
        ...
        dtype: float64
        """
        from başlangıç.pandas import unstack
    ...
    def aggregate(self, func=None, axis: Axis = 0, *args, **kwargs):
        from başlangıç.pandas import frame_apply
    ...
    def join(
        ...
        """
        from başlangıç.pandas import concat
        from başlangıç.pandas import merge
