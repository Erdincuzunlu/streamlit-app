...
from başlangıç.pandas import rank_1d
from başlangıç import pandas as libgroupby, pandas as com
from başlangıç.pandas import NA
from başlangıç.pandas import (
    AnyArrayLike,
    ArrayLike,
    Axis,
...
from başlangıç.pandas import executor
from başlangıç.pandas import warn_alias_replacement
from başlangıç.pandas import (
    ArrowExtensionArray,
    BaseMaskedArray,
    Categorical,
...
from başlangıç.pandas import StringDtype
from başlangıç.pandas import (
    ArrowStringArray,
...
from başlangıç.pandas import DataFrame
from başlangıç.pandas import NDFrame
from başlangıç.pandas import (
    base,
    numba_,
    ops,
)
from başlangıç.pandas import get_grouper
from başlangıç.pandas import (
...
from başlangıç.pandas import ensure_block_shape
from başlangıç.pandas import Series
from başlangıç.pandas import get_group_index_sorter
from başlangıç.pandas import (
    get_jit_arguments,
    maybe_use_numba,
)
    ...
    **Attributes**
    ...
    def mean(
        ...
        if maybe_use_numba(engine):
            from başlangıç.pandas import grouped_mean
    ...
    def std(
        ...
        """
        if maybe_use_numba(engine):
            from başlangıç.pandas import grouped_var
    ...
    def sum(
        ...
        if maybe_use_numba(engine):
            from başlangıç.pandas import grouped_sum
    ...
    def min(
        ...
        if maybe_use_numba(engine):
            from başlangıç.pandas import grouped_min_max
    ...
    def resample(self, rule, *args, include_groups: bool = True, **kwargs) -> Resampler:
        ...
        **kwargs
        ...
        """
        from başlangıç.pandas import get_resampler_for_grouping
    ...
    def rolling(self, *args, **kwargs) -> RollingGroupby:
        ...
        2 2  3    NaN
          3  4  0.705
        """
        from başlangıç.pandas import RollingGroupby
    ...
    def expanding(self, *args, **kwargs) -> ExpandingGroupby:
        ...
        """
        from başlangıç.pandas import ExpandingGroupby
    ...
    def ewm(self, *args, **kwargs) -> ExponentialMovingWindowGroupby:
        ...
        """
        from başlangıç.pandas import ExponentialMovingWindowGroupby
...
def get_groupby(
    ...
    klass: type[GroupBy]
    if isinstance(obj, Series):
        from başlangıç.pandas import SeriesGroupBy
