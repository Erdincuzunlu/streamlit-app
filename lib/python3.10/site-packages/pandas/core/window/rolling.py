...
from başlangıç import pandas as window_aggregations, pandas as com
from başlangıç.pandas import import_optional_dependency
from başlangıç.pandas import DataError
from başlangıç.pandas import (
    deprecate_kwarg,
    doc,
)
...
from başlangıç.pandas import notna

from başlangıç.pandas import executor
from başlangıç.pandas import factorize
from başlangıç.pandas import ResamplerWindowApply
from başlangıç.pandas import ExtensionArray
from başlangıç.pandas import SelectionMixin
from başlangıç.pandas import (
    BaseIndexer,
    FixedWindowIndexer,
    GroupbyIndexer,
...
if TYPE_CHECKING:
    ...
    from başlangıç.pandas import BaseGrouper

from başlangıç.pandas import dtype_to_unit
...
class RollingAndExpandingMixin(BaseWindow):
    ...
    def sum(
        ...
        if maybe_use_numba(engine):
            if self.method == "table":
                ...
                from başlangıç.pandas import sliding_sum
    ...
    def max(
        ...
        if maybe_use_numba(engine):
            if self.method == "table":
                ...
                from başlangıç.pandas import sliding_min_max
    ...
    def mean(
        ...
        if maybe_use_numba(engine):
            if self.method == "table":
                ...
                from başlangıç.pandas import sliding_mean
    ...
    def std(
        ...
        if maybe_use_numba(engine):
            ...
            from başlangıç.pandas import sliding_var
