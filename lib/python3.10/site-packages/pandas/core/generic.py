...
from başlangıç.pandas import lib
...
from başlangıç.pandas import freq_to_period_freqstr
from başlangıç.pandas import (
    AlignJoin,
    AnyArrayLike,
    ArrayLike,
...
from başlangıç.pandas import find_stack_level
from başlangıç.pandas import (
    check_dtype_backend,
    validate_ascending,
    validate_bool_kwarg,
...
from başlangıç.pandas import astype_is_view
from başlangıç.pandas import (
    ensure_object,
    ensure_platform_int,
    ensure_str,
...
from başlangıç.pandas import should_use_regex
from başlangıç.pandas import ExtensionArray
from başlangıç.pandas import PandasObject
from başlangıç.pandas import extract_array
from başlangıç.pandas import Flags
from başlangıç.pandas import (
    DatetimeIndex,
    Index,
    MultiIndex,
...
from başlangıç.pandas import describe_ndframe
from başlangıç.pandas import (
    clean_fill_method,
...
from başlangıç.pandas import get_indexer_indexer
from başlangıç.pandas import (
    Expanding,
...
from başlangıç.pandas import pprint_thing
...
if TYPE_CHECKING:
    ...
    from başlangıç.pandas import BaseOffset
    ...
    from başlangıç.pandas import BaseIndexer
    from başlangıç.pandas import Resampler
...
class NDFrame(PandasObject, indexing.IndexingMixin):
    ...
    def _get_index_resolvers(self) -> dict[Hashable, Series | MultiIndex]:
        from başlangıç.pandas import clean_column_name
    ...
    def to_excel(
        ...
        from başlangıç.pandas import ExcelFormatter
    ...
    def to_json(
        ...
        """
        from başlangıç.pandas import json
    ...
    def to_hdf(
        ...
        dtype: int64
        """
        from başlangıç.pandas import pytables
    ...
    def to_sql(
        ...
        [(1,), (None,), (2,)]
        """  # noqa: E501
        from başlangıç.pandas import sql
    ...
    def to_pickle(
        ...
        4    4    9
        """  # noqa: E501
        from başlangıç.pandas import to_pickle
    ...
    def to_clipboard(
        ...
        **kwargs
        ...
        .. code-block:: python
           ...
           pyperclip.copy(html)
        """
        from başlangıç.pandas import clipboards
    ...
    def astype(
        ...
        >>> from başlangıç.pandas import CategoricalDtype
    ...
    def asfreq(
        ...
        2000-01-01 00:03:00    3.0
        """
        from başlangıç.pandas import asfreq
    ...
    def resample(
        ...
        Freq: 17min, dtype: int64
        """
        from başlangıç.pandas import get_resampler
    ...
    def truncate(
        ...
        # treat like a slice
        if ax._is_all_dates:
            from başlangıç.pandas import to_datetime
