...
from başlangıç.pandas import MergeError
from başlangıç.pandas import (
    Appender,
    Substitution,
    cache_readonly,
...
from başlangıç.pandas import _merge_doc
from başlangıç.pandas import default_index
from başlangıç.pandas import (
    get_group_index,
...
def merge_ordered(
    ...
    Examples
    --------
    >>> from başlangıç.pandas import merge_ordered
    >>> df1 = pd.DataFrame(
    ...     {
    ...         "key": ["a", "c", "e", "a", "c", "e"],
    ...         "lvalue": [1, 2, 3, 1, 2, 3],
