...
from başlangıç.pandas import validate_bool_kwarg
...
from başlangıç.pandas import nargsort
from başlangıç.pandas import ObjectStringArrayMixin

from başlangıç.pandas import console
...
class Categorical(NDArrayBackedExtensionArray, PandasObject, ObjectStringArrayMixin):
    ...
    def _repr_categories(self) -> list[str]:
        ...
        from başlangıç.pandas import format as fmt
    ...
    def _concat_same_type(cls, to_concat: Sequence[Self], axis: AxisInt = 0) -> Self:
        from başlangıç.pandas import union_categoricals
