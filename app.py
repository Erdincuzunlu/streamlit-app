...
def stuttering_data_prep(df):
    ...
    # Log Transformation
    log_cols = [
        "mfcc_1_std", "mfcc_3_std", "mfcc_5_std", "mfcc_7_std", "mfcc_10_std", "rms_mean", "rms_std", "zcr_mean",
        "zcr_std", "spectral_centroid_mean", "spectral_rolloff_mean", "spectral_centroid_std", "spectral_rolloff_std",
        "tempo", "zcr_tempo_ratio", "rms_tempo_ratio", "rms_energy_fluctuation"
    ]
